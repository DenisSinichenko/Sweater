...
public class UserService implements UserDetailsService {
    ...
    public void updateProfile(User user, String password, String email) {
        ...
        jdbcTemplate.update("UPDATE sweater.users SET email = '" + user.getEmail() + "', password = '" + user.getPassword() + "' WHERE id = " + user.getId());
    }
    ...
    public List<User> getUsers() {
        String sql = " SELECT u.id, u.username, ur.roles" +
                " FROM sweater.users u" +
                " LEFT JOIN sweater.user_role ur ON u.id = ur.user_id";
